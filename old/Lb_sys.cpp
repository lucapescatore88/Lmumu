...
void getAllEffSys(
	...
	vector <TH1F * >  * hdefault, vector <TH1F * > * lfsys_plus, vector <TH1F * > * lfsys_minus,
	...
	vector <TH1F * >  * poljpsi7, vector <TH1F * > * poljpsi8, vector <TH1F * >  * DDsys, bool sys, string opt = "", bool jpsi = false )
{
	TString isDecay = "";
	...
	//treeUp, cutUp, treeDown, cutDown, "",
	//treeJpsiUp, cutJpsiUp, treeJpsiDown, cutJpsiDown, "", opt) );
