...
void fillInputArray(TreeReader* reader, float* array)
{
	...
	if(trackType == 3)
	{
		...
		array[10] = -999;
		array[11] = -999;
		array[12] = reader->GetValue( "piminus_IPCHI2_OWNPV");
		array[13] = reader->GetValue( "pplus_IPCHI2_OWNPV");
		array[14] = -999;
		array[15] = -999;
	}
	else
	{
		array[8] = -999;
		array[9] = -999;
		array[10] = reader->GetValue( "Lambda0_IPCHI2_OWNPV");
		array[11] = reader->GetValue( "Lambda0_FD_OWNPV");
		array[12] = -999;
		array[13] = -999;
	...
	//array[12] = reader->GetValue( "pplus_IPCHI2_OWNPV");
	//array[13] = reader->GetValue( "piminus_IPCHI2_OWNPV");
}
