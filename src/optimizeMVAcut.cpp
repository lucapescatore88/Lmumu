...
int main(int argc, char** argv)
{
	...
	*/
	...
	TString type = "all";
	TString namefilesig = "/afs/cern.ch/work/p/pluca/Lmumu/weighted/Lb2Lmumu_MC_Pythia8_NBweighted.root";
	TString namefilebkg = "/afs/cern.ch/work/p/pluca/Lmumu/weighted/Lb2Lmumu_CL_NBweighted.root";
